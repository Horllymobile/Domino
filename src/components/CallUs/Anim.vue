<template>
    <div  class="anim_container">
        ...
        <transition
            ...
            appear=""
        >
            <div class="plus one" delay="100" left="300">+</div>
        </transition>
        ...
        <transition
            ...
            appear=""
        >
            <div class="icon icon_delivery" delay="200" left="450"></div>
        </transition>
        ...
        <transition
            ...
            appear=""
        >
            <div class="plus one" delay="300" left="650">=</div>
        </transition>
        <transition
            v-on:before-enter="beforeEnter"
            v-on:enter="enter"
            appear=""
        >
            <div class="icon icon_pizza" delay="200" left="800"></div>
        </transition>
    </div>
</template>
